...
function Cache:repair(m)
    ...
    logger.dbg("FingerInk: canvas repair,", stats.candidates, "candidates,",
...
function Cache:endErase(ctx)
    ...
    logger.dbg("FingerInk: canvas erase,", s.candidates or 0, "candidates,",
...
function Cache:_fail(reason)
    ...
    logger.err("FingerInk: canvas could not be loaded:", self.load_error)
